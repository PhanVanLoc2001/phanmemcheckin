 // In real app replace with:
        ...
        function attachOnClickListenerToButton() {
            let elBtn = document.getElementById("btn-price");
            // Style button as ready to be pressed
            elBtn.style.opacity = 1;
            elBtn.style.cursor = "pointer";
            let elLoading = document.getElementById("loading-price");
        ...
        function showSelectedImage(files) {
            let elImages = document.getElementById("images-price");
            elImages.innerHTML = "";
